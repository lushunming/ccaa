...
master_url='https://github.com/lushunming/ccaa/archive/master.zip'
...
#    chmod +x build-aria2.sh && sh build-aria2.sh
	cd
}
...
function dealconf(){
	...
	cp /etc/ccaa/upbt.sh /etc/periodic/daily/upbt
	echo " echo 'test' >> /app/test.log" >>/etc/periodic/15min/test
